var url1="https://cdn.glitch.global/25ac2c89-9dc7-4d65-8977-00a3df60e85c/";
function texto_federico()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"federico2.jpg' width='200' height='250'><p>" +
          "<img src='"+url1+"federico3.jpg' width='200' height='250'>" +
          "</td>" +
...
function texto_ireneo()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"ireneo.jpg' width='200' height='250'>" +
          "</td>" +
...
function texto_issac()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"issac2.jpg' width='200' height='250'>" +
          "</td>" +
...
function texto_filemon()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"filemon.jpg' width='200' height='250'>" +
          "</td>" +
...
function texto_domitila()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"domitila.jpg' width='200' height='250'>" +
          "</td>" +
        ...
        "</td>" + "</tr>" + "</table>" + "Haga click para continuar" + "</div>";
  return texto;
}
function texto_cirilo()
{  
   var texto="<div class='paneltexto'>" +
          "<table>" +
          "<tr>" +
          "<td>" +
          "<img src='"+url1+"cirilo.jpg' width='200' height='250'>" +
          "</td>" +
